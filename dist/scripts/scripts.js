...
var titleCarouselWrapper = function titleCarouselWrapper() {
  var titleCarousel = document.getElementById('title-carousel'); //TODO: CLEANUP: top
  ...
  var title = document.getElementById('title'); //TODO: CLEANUP: top
  var titleSetter = function titleSetter(newTitle) {
    ...
    var carouselBuilder = function carouselBuilder() {
      var titleCarousel = document.getElementById('empty-arrow');
    };
  ...
  var carouselEvents = function carouselEvents() {
    var titleCarousel = document.getElementById('arrow');
